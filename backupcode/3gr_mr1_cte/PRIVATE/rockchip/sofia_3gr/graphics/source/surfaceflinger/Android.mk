...
ifeq ($(strip $(TARGET_BOARD_PLATFORM_VAR)),sofia3gr_garnet)

LOCAL_CLANG := true

ifeq ($(strip $(LOCAL_PATH)), vendor/PRIVATE/rockchip/sofia_3gr/graphics/source/surfaceflinger)
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../include $(LOCAL_PATH)/../opengl/include
endif
...
LOCAL_SRC_FILES:= \
    Client.cpp \
    DisplayDevice.cpp \
    DispSync.cpp \ EventControlThread.cpp \
    EventThread.cpp \
    FrameTracker.cpp \
    Layer.cpp \
    LayerDim.cpp \
