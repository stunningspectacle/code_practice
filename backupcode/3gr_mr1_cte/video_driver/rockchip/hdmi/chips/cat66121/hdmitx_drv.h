...
struct hdmitx_dev {
	...
	/* Interrupt type */
	BYTE binttype;
	/* Video Property for Sync Embedded, CCIR656, InputDDR*/
	BYTE binputvideosignaltype;
	/* Audio Property */
	BYTE boutputaudiomode;
	BYTE baudiochannelswap;
...
#define REGPKTAUDCTS0	0x30
#define REGPKTAUDCTS1	0x31
#define REGPKTAUDCTS2	0x32
#define REGPKTAUDN0	0x33
#define REGPKTAUDN1	0x34
#define REGPKTAUDN2	0x35
#define REGPKTAUDCTSCNT0	0x35
#define REGPKTAUDCTSCNT1	0x36
#define REGPKTAUDCTSCNT2	0x37

#define REG_TX_AUDCHST_MODE	0x91
#define REG_TX_AUDCHST_CAT	0x92
#define REG_TX_AUDCHST_SRCNUM	0x93
#define REG_TX_AUD0CHST_CHTNUM	0x94
#define REG_TX_AUD1CHST_CHTNUM	0x95
#define REG_TX_AUD2CHST_CHTNUM	0x96
#define REG_TX_AUD3CHST_CHTNUM	0x97
#define REG_TX_AUDCHST_CA_FS	0x98
#define REG_TX_AUDCHST_OFS_WL	0x99
...
#define REG_TX_PKT_AUDINFO_CC	0x68
#define REG_TX_PKT_AUDINFO_SF	0x69
#define REG_TX_PKT_AUDINFO_CA	0x6B

#define REG_TX_PKT_AUDINFO_DM_LSV	0x6C
#define REG_TX_PKT_AUDINFO_SUM	0x6D
...
BYTE check_hdmitx(BYTE *phpd, BYTE *phpdchange);
...
/* TBD ... */
/* #ifdef SUPPORT_DEGEN */
/* BOOL ProgramDEGenModeByID(MODE_ID id, BYTE binput_signaltype); */
/* #endif // SUPPORT_DEGEN */

#ifdef SUPPORT_SYNCEMBEDDED
BOOL sethdmitx_syncembedded_by_vic(BYTE VIC, BYTE binput_signaltype);
#endif

void hdmitx_setinputmode(BYTE inputmode, BYTE binput_signaltype);
...
void hdmitx_enable_audiooutput(BYTE audiotype, BOOL bspdif, ULONG samplefreq,
			       BYTE chnum, BYTE *piec60958chstat,
			       ULONG TMDSCLOCK);
...
extern struct hdmitx_dev hdmitxdev[HDMITX_MAX_DEV_COUNT];
void hdmitx_loadregsetting(struct regsetentry table[]);
...
void hdmitx_setinputmode(BYTE inputmode, BYTE binput_signaltype);
void hdmitx_setcscscale(BYTE binputmode, BYTE boutputmode);
void hdmitx_setupafe(enum pclk_level pclklevel);
void hdmitx_fireafe(void);
