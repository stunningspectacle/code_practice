...
static const struct fb_videomode hdmi_mode[] = {
	 ...
	 * h_bp	h_fp v_bp v_fp h_pw v_pw
	 * polariry PorI flag(used for vic)
	 */
/*
	{"640x480p@60Hz", 60, 640, 480, 25175000,
	 48, 16, 33, 10, 96, 2, 0, 0, 1 },
*/
	{"720x480i@60Hz", 60, 720, 480, 27000000,
	 57, 19, 15, 4, 62, 3, 0, 1, 6 },
	{"720x576i@50Hz", 50, 720, 576, 27000000,
	 69, 12, 19, 2, 63, 3, 0, 1, 21},
	{"720x480p@60Hz", 60, 720, 480, 27000000,
	 60, 16, 30, 9, 62, 6, 0, 0, 2 },
	{"720x576p@50Hz", 50, 720, 576, 27000000,
	 68, 12, 39, 5, 64, 5, 0, 0, 17},
/*
	{"1280x720p@24Hz", 24, 1280, 720, 59400000,
	 220, 1760, 20, 5, 40, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 60},
	{"1280x720p@25Hz", 25, 1280, 720, 74250000,
	 220, 2420, 20, 5, 40, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 61},
	{"1280x720p@30Hz", 30, 1280, 720, 74250000,
	 220, 1760, 20, 5, 40, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 62},
*/
	{"1280x720p@50Hz", 50, 1280, 720, 74250000,
	 220, 440, 20, 5, 40, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 19},
	{"1280x720p@60Hz", 60, 1280, 720, 74250000,
	 220, 110, 20, 5, 40, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 4 },
/*
	{"1920x1080p@24Hz", 24, 1920, 1080, 74250000,
	 148, 638, 36, 4, 44, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 32},
	{"1920x1080p@25Hz", 25, 1920, 1080, 74250000,
	 148, 528, 36, 4, 44, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 33},
	{"1920x1080p@30Hz", 30, 1920, 1080, 74250000,
	 148, 88, 36, 4, 44, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 34},
	{"1920x1080i@50Hz_2", 50, 1920, 1080, 72000000,
	 184, 32, 57, 23, 168, 5, FB_SYNC_HOR_HIGH_ACT, 1, 39},
*/
	{"1920x1080i@50Hz", 50, 1920, 1080, 74250000,
	 148, 528, 15, 2, 44, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 1, 20},
	{"1920x1080i@60Hz", 60, 1920, 1080, 74250000,
	 148, 88, 15, 2, 44, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 1, 5 },
	{"1920x1080p@50Hz", 50, 1920, 1080, 148500000,
	 148, 528, 36, 4, 44, 5,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 31},
	{"1920x1080p@60Hz", 60, 1920, 1080, 148500000,
	 148, 88, 36, 4, 44,
	 5, FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 16},
/*
	{"1440x288p@50Hz", 50, 720, 480, 27000000,
	 138, 24, 19, 2, 126, 3, 0, 0, 23},
	{"2880x576i@50Hz", 50, 1440, 240, 54000000,
	 276, 48, 19, 2, 252, 3, 0, 1, 25},
	{"2880x288p@50Hz", 50, 2880, 480, 54000000,
	 276, 48, 19, 3, 252, 3, 0, 0, 27},
	{"1440x576p@50Hz", 50, 2880, 480, 54000000,
	 136, 24, 39, 5, 128, 5, 0, 0, 29},
	{"2880x576p@50Hz", 50, 1920, 1080, 108000000,
	 272, 48, 39, 5, 256, 5, 0, 0, 37},
	{"1440x240p@60Hz", 60, 1440, 240, 27000000,
	 114, 38, 15, 4, 124, 3, 0, 0, 8 },
	{"2880x480i@60Hz", 60, 2880, 480, 54000000,
	 228, 76, 15, 4, 248, 3, 0, 1, 10},
	{"2880x480p@60Hz", 60, 2880, 480, 54000000,
	 228, 76, 15, 4, 248, 3, 0, 0, 12},
	{"1440x480p@60Hz", 60, 1440, 480, 54000000,
	 120, 32, 30, 9, 124, 6, 0, 0, 14},
	{"2880x480p@60Hz", 60, 2880, 480, 54000000,
	 240, 64, 30, 9, 248, 6, 0, 0, 35},
	{"1920x1080i@100Hz", 100, 1920, 1080, 148500000,
	 148, 528, 15, 2, 44, 5, 1, 1, 40},
	{"1280x720p@100Hz", 100, 1280, 720, 148500000,
	 220, 440, 20, 5, 40, 5, 1, 0, 41},
	{"720x576p@100Hz", 100, 720, 576, 54000000,
	 68, 12, 39, 5, 64, 5, 0, 0, 42},
	{"1440x576i@100Hz", 100, 1440, 576, 54000000,
	 138, 24, 19, 2, 12, 3, 0, 1, 44},
	{"1920x1080p@100Hz", 100, 1920, 1080, 297000000,
	 148, 528, 36, 4, 44, 5, 1, 0, 64},

	{"1920x1080i@120Hz", 120, 1920, 1080, 148500000,
	 148, 88, 15, 2, 44, 5, 1, 1, 46},
	{"1280x720p@120Hz", 120, 1280, 720, 148500000,
	 220, 110, 20, 5, 40, 5, 1, 0, 47},
	{"720x480p@120Hz", 120, 720, 480, 54000000,
	 60, 16, 30, 9, 62, 6, 0, 0, 48},
	{"1440x480i@120Hz", 120, 1440, 480, 54000000,
	 114, 38, 15, 4, 12, 3, 0, 1, 50},
	{"1920x1080p@120Hz", 120, 1920, 1080, 297000000,
	 148, 88, 36, 4, 44, 5, 1, 0, 63},

	{"720x576p@200Hz", 200, 720, 576, 108000000,
	 68, 12, 39, 5, 64, 5, 0, 0, 52},
	{"1440x576i@200Hz", 200, 1920, 1080, 108000000,
	 138, 24, 19, 2, 12, 3, 0, 1, 54},

	{"720x480p@240Hz", 240, 720, 480, 108000000,
	 60, 16, 30, 9, 62, 6, 0, 0, 56},
	{"1440x480i@240Hz", 240, 1440, 480, 108000000,
	 114, 38, 15, 4, 12, 3, 0, 1, 58},
*/
	{"3840x2160p@24Hz", 24, 3840, 2160, 297000000,
	 296, 1276, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 93},
	{"3840x2160p@25Hz", 25, 3840, 2160, 297000000,
	 296, 1056, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 94},
	{"3840x2160p@30Hz", 30, 3840, 2160, 297000000,
	 296, 176, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 95},
	{"3840x2160p@50Hz", 50, 3840, 2160, 594000000,
	 296, 1056, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 96},
	{"3840x2160p@60Hz", 60, 3840, 2160, 594000000,
	 296, 176, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 97},
	{"4096x2160p@24Hz", 24, 4096, 2160, 297000000,
	 296, 1020, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 98},
	{"4096x2160p@25Hz", 25, 4096, 2160, 297000000,
	 128, 968, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 99},
	{"4096x2160p@30Hz", 30, 4096, 2160, 297000000,
	 128, 88, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 100},
	{"4096x2160p@50Hz", 50, 4096, 2160, 594000000,
	 128, 968, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 101},
	{"4096x2160p@60Hz", 60, 4096, 2160, 594000000,
	 128, 88, 72, 8, 88, 10,
	 FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, 0, 102},
};

int hdmi_set_info(struct rockchip_screen *screen, unsigned int vic)
{
	int i;
	...
	memset(screen, 0, sizeof(struct rockchip_screen));
...
static void hdmi_show_sink_info(struct hdmi *hdmi)
{
	...
	for (i = 0; i < hdmi->edid.audio_num; i++) {
		...
		case HDMI_AUDIO_WMA_PRO:
			...
			break;
		default:
			hdmi_dbg(hdmi->dev, "Support audio type: Unknown\n");
			break;
		}
		...
		hdmi_dbg(hdmi->dev, "Support audio word length:\n");
...
/**
 * hdmi_switch_fb: switch vop mode to required video mode
 * @hdmi:
 * @type:
 *
 * NOTES:
...
int hdmi_switch_fb(struct hdmi *hdmi, int vic)
{
	...
	if (rc == 0) {
		/* turn off vif for jettab */
		if (hdmi->set_vif)
			hdmi->set_vif(hdmi, screen, 0);
		rockchip_fb_switch_screen(screen, true, hdmi->vop->id);
		rockchip_fb_disp_scale(hdmi->xscale,
				       hdmi->yscale, hdmi->vop->id);
		if (hdmi->set_vif)
...
{
	struct rockchip_vop_driver *vop_drv = NULL;

	if (unlikely(hdmi_drv == NULL))
		return -1;

	vop_drv = hdmi_drv->vop;
	if (unlikely(vop_drv == NULL))
		return -1;
	...
	if (vop_drv->output_color == COLOR_RGB)
