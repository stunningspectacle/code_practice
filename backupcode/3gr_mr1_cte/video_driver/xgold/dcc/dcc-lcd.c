...
#define DCC_IRQ_ERR_ENABLED_level1 \
	(DCC_IRQ_ERR_MASK & (~DCC_IRQ_ERR_IDLE) & (~DCC_IRQ_ERR_DSIFIN))
...
int dcc_display_setup(struct dcc_drvdata *pdata)
{
	...
	gra_write_field(pdata, EXR_DIF_ERRIRQSM, DCC_IRQ_ERR_ENABLED_level1);
