...
#define GET_VPU_INTO_FROM_HEAD      1 //zxl: 1:get vpu info from head of handle base  0:get vpu info from end of handle base
...
#define GRALLOC_ARM_UMP_NUM_INTS 0
    ...
    int     type;
#define GRALLOC_ARM_DMA_BUF_NUM_INTS (2+6)
#else
