...
static int rk_vop_win_enable(struct rk_display *disp, int win_id, bool enable)
{
...
static void rk_vop_update_win_regs(struct rk_display *disp,
...
static int rk_vop_set_par(struct rk_display *disp, struct fb_dsp_info *fb_info)
{
...
static void rk_vop_panel_display(struct rk_display *disp,
...
static int rk_vop_load_screen(struct rk_display *display,
...
static int rk_vop_open(struct rk_display *disp, int win_id, bool enable)
{
	if (win_id < NUM_WIN)
