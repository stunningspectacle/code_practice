...
#elif (TRC_CFG_HARDWARE_PORT == TRC_HARDWARE_PORT_Intel_ISH)
	#define TRC_HWTC_TYPE TRC_FREE_RUNNING_32BIT_INCR
	//#define TRC_HWTC_COUNT (get_rtc()) 
	#define TRC_HWTC_COUNT (rdtsc()) 
	#define TRC_HWTC_PERIOD 0
	#define TRC_HWTC_DIVISOR 1
	//#define TRC_HWTC_FREQ_HZ 32768 
	#define TRC_HWTC_FREQ_HZ configCPU_CLOCK_HZ						
