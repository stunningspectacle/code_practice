...
/*******************************************************************************
 * TRC_RECORDER_TRANSFER_METHOD_HECI
 * 
 * This stream port for HECI uses a temporary buffer consisting of multiple 
 * pages, that are transmitted periodically by the SMHI task. You can modify 
 * the supporting functions to match your system. See trcStreamingPort.c
 ******************************************************************************/
#define TRC_RECORDER_TRANSFER_METHOD_HECI 1
...
#define TRC_STREAM_PORT_ALLOCATE_FIELDS() __pinned_kernel_bss__ static char _TzTraceData[TRC_CFG_PAGED_EVENT_BUFFER_PAGE_COUNT * TRC_CFG_PAGED_EVENT_BUFFER_PAGE_SIZE];       /* Static allocation. */
...
#define TRC_STREAM_PORT_READ_DATA(_ptrData, _size, _ptrBytesRead) trcHECIRead(_ptrData, _size, _ptrBytesRead);
//#define TRC_STREAM_PORT_PERIODIC_SEND_DATA(_ptrBytesSent) prvPagedEventBufferTransfer(trcLOGWrite, _ptrBytesSent);
#define TRC_STREAM_PORT_PERIODIC_SEND_DATA(_ptrBytesSent, _destdata, _destsize) prvPagedEventBufferTransfer(trcHECIWrite, _ptrBytesSent, _destdata, _destsize);
