...
__pinned_kernel_data__ uint32_t trace_disable_timestamp = 0;

__pinned_kernel_data__ static uint32_t last_timestamp = 0;
/* Flag that shows if inside a critical section of the recorder */
__pinned_kernel_data__ volatile int recorder_busy = 0;
 ...
 ******************************************************************************/
#if (TRC_CFG_SCHEDULING_ONLY == 0)
__pinned_kernel_code__ void prvTraceStoreKernelCallWithNumericParamOnly(uint32_t evtcode, uint32_t param)
{
 ...
 *
 ******************************************************************************/
__pinned_kernel_code__ void prvTracePortGetTimeStamp(uint32_t *pTimestamp)
{
