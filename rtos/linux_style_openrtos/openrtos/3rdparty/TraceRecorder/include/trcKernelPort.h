 ...
 ******************************************************************************/
#define EVENTGROUP_CREATE_OBJ_SUCCESSED	(EVENTGROUP_OBJCLOSE_PROP + 8)	/*0x18*/
 ...
 * or mutex).
 ******************************************************************************/
#define EVENTGROUP_SEND_SUCCESSED	(EVENTGROUP_CREATE_OBJ_SUCCESSED + 8)		/*0x20*/
 ...
 * or mutex).
 ******************************************************************************/
#define EVENTGROUP_RECEIVE_SUCCESSED	(EVENTGROUP_SEND_SUCCESSED + 8)		/*0x28*/

/* Send/Give operations, from ISR */
#define EVENTGROUP_SEND_FROM_ISR_SUCCESSED \
									(EVENTGROUP_RECEIVE_SUCCESSED + 8)	/*0x30*/

/* Receive/Take operations, from ISR */
#define EVENTGROUP_RECEIVE_FROM_ISR_SUCCESSED \
							(EVENTGROUP_SEND_FROM_ISR_SUCCESSED + 8)		/*0x38*/

/* "Failed" event type versions of above (timeout, failed allocation, etc) */
#define EVENTGROUP_KSE_FAILED \
							(EVENTGROUP_RECEIVE_FROM_ISR_SUCCESSED + 8)	/*0x40*/
...
#define EVENTGROUP_PEEK_SUCCESSED	(EVENTGROUP_SEND_BLOCK + 8)				/*0x78*/

/* Events on object delete (vTaskDelete or vQueueDelete) */
#define EVENTGROUP_DELETE_OBJ_SUCCESSED	(EVENTGROUP_PEEK_SUCCESSED + 8)	/*0x80*/

/* Other events - object class is implied: TASK */
#define EVENTGROUP_OTHERS	(EVENTGROUP_DELETE_OBJ_SUCCESSED + 8)			/*0x88*/
...
#define traceQUEUE_SEND( pxQueue ) \
	trcKERNEL_HOOKS_KERNEL_SERVICE(SEND, SUCCESSED, UNUSED, pxQueue); \
...
#define traceQUEUE_RECEIVE( pxQueue ) \
	trcKERNEL_HOOKS_KERNEL_SERVICE(RECEIVE, SUCCESSED, UNUSED, pxQueue); \
...
#define traceQUEUE_PEEK( pxQueue ) \
	trcKERNEL_HOOKS_KERNEL_SERVICE(PEEK, SUCCESSED, UNUSED, pxQueue);

/* Called when a message is sent from interrupt context, e.g., using xQueueSendFromISR */
#undef traceQUEUE_SEND_FROM_ISR
#define traceQUEUE_SEND_FROM_ISR( pxQueue ) \
	trcKERNEL_HOOKS_KERNEL_SERVICE(SEND_FROM_ISR, SUCCESSED, UNUSED, pxQueue); \
...
#define traceQUEUE_RECEIVE_FROM_ISR( pxQueue ) \
	trcKERNEL_HOOKS_KERNEL_SERVICE(RECEIVE_FROM_ISR, SUCCESSED, UNUSED, pxQueue); \
	trcKERNEL_HOOKS_SET_OBJECT_STATE(UNUSED, pxQueue, (uint8_t)(pxQueue->uxMessagesWaiting - 1));
