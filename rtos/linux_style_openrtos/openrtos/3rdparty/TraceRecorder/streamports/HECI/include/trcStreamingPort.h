...
#define TRC_STREAM_PORT_PERIODIC_SEND_DATA_HECI(_ptrBytesSent, _destdata, _destsize) prvPagedEventBufferTransferHECI(trcHECIWrite, _ptrBytesSent, _destdata, _destsize);
