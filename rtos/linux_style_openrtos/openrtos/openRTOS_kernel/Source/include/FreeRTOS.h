...
/* The following event macros are embedded in the kernel API calls. */
...
#ifndef pvPortStackAllocAligned
	#define pvPortStackAllocAligned( x, puxStackBuffer ) ( ( ( puxStackBuffer ) == NULL ) ? ( pvPortStackAlloc( ( x ) ) ) : ( puxStackBuffer ) )
#endif
...
#ifndef vPortStackFreeAligned
	#define vPortStackFreeAligned( pvBlockToFree ) vPortStackFree( pvBlockToFree )
#endif
	...
	#define configEXPECTED_IDLE_TIME_BEFORE_SLEEP 0
     ...
     // for ISH PM, need set this value to 0
